...
pub mod acts_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("acts.grpc.ActsService", "Send"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("acts.grpc.ActsService", "OnMessage"));
...
pub mod acts_service_server {
    ...
    #[async_trait]
    pub trait ActsService: std::marker::Send + std::marker::Sync + 'static {
        async fn send(
            &self,
            request: tonic::Request<super::Message>,
        ) -> std::result::Result<tonic::Response<super::Message>, tonic::Status>;
        /// Server streaming response type for the OnMessage method.
        type OnMessageStream: tonic::codegen::tokio_stream::Stream<
        ...
        ) -> std::result::Result<tonic::Response<Self::OnMessageStream>, tonic::Status>;
    }
    /// acts service
    #[derive(Debug)]
    pub struct ActsServiceServer<T> {
        inner: Arc<T>,
                ...
                "/acts.grpc.ActsService/Send" => {
                    ...
                    for SendSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ActsService>::send(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/acts.grpc.ActsService/OnMessage" => {
                    ...
                    for OnMessageSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ActsService>::on_message(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for ActsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "acts.grpc.ActsService";
    impl<T> tonic::server::NamedService for ActsServiceServer<T> {
